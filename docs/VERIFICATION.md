...
Four Streamlit AppTest tests cover native page rendering, top synthetic notice, case creation and client-role isolation, inserting/saving/validating/publishing a workflow step, and required custom fields in the profile builder. Tests use temporary storage.
